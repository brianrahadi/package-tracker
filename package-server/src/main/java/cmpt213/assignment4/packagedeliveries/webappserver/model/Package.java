...
/**
 * A class to store information of a package including name, notes, price, weight, delivered, and expected delivery
 * date.
 * @author brianrahadi
 */
...
public class Package implements Comparable<Package> {
    ...
    public void setId(long id) {
     ...
     /**
      * this gives warning since the method usage is always inverted. I removed the warning because
